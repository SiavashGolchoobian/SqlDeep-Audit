...
<b>Syntax:</b><br>
	...
	<b>Examples:</b>
	<b>A.Collecting counters on disk via interactive questions.</b>
	...
	<b>B.Collecting counters to sql server database tables via interactive questions.</b>
	...
	<b>C.Collecting counters on disk in silent mode (not interactive mode).</b>
	...
	<b>D.Collecting counters to sql server database tables in silent mode (not interactive mode).</b>
